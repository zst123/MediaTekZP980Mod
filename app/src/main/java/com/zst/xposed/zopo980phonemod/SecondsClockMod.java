...
public class SecondsClockMod {
    ...
    public static final boolean enabled = true; //Clock Enabled?
    ...
    private static final boolean allowHtml = false; //Allow HTML tags to be used?
    ...
    private static final int letterCaseType = LETTER_DEFAULT;
